...
int SocketOperator::recvMessage(unsigned char *buffer, sockaddr_in &senderAddr) {
...
void SocketOperator::sendBuffer(unsigned char *buffer, int bufferSize, sockaddr_in addr) {
